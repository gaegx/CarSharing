...
public final class DeleteBookingUseCase {

    private final BookingRepository bookingRepository;
    private final AppExecutors executors;

    @Inject
    public DeleteBookingUseCase(@NonNull BookingRepository bookingRepository,
    ...
    public void execute(@NonNull Booking booking, @NonNull ResultCallback<Void> callback) {
        executors.runOnDiskIo(() ->
                bookingRepository.delete(booking, result -> executors.runOnMainThread(() -> callback.onResult(result)))
        );
    }
}
